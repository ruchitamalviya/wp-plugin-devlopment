    ...
    ?>
        <div class="child_container">
            ...
            <form method="post" action="<?php echo get_site_url() . '/wp-admin/admin-post.php'; ?>" id="register">
                ...
                <input type="hidden" id="upload_receipt_logo" name="upload_receipt_logo" value="<?php if (isset($receipt_logo) && $receipt_logo) {
                    echo $receipt_logo; } ?>"/><br><br>
                ...
                <input type="text" id="receipt_title" name="receipt_title" value="<?php if (isset($receipt_title) && $receipt_title) {
                    echo $receipt_title; } ?>"><br><br>
...
wp_editor("$footer_content", "receipt_footer"); ?>
                ...
                <textarea id="receipt_content" name="receipt_content" rows="4" cols="35"><?php if (isset($receipt_content) && $receipt_content) {
                    echo $receipt_content; } ?></textarea><br><br>
