 ...
 * @subpackage Pmpro_Better_Membership_Receipts/public
 */
 ...
 */
class Pmpro_Better_Membership_Receipts_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/pmpro-better-membership-receipts-public.css', array(), $this->version, 'all' );
